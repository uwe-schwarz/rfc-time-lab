  ...
  useEffect(() => {
    ...
    class MouseClass {
      constructor() {
        ...
        this._onMouseOut = this.onWindowMouseOut.bind(this);
        this._onMouseOver = this.onMouseEnter.bind(this);
      ...
      init(container) {
        ...
        window.addEventListener('mouseover', this._onMouseOver, false);
      ...
      dispose() {
        ...
        window.removeEventListener('mouseover', this._onMouseOver, false);
